...
-- 3. Copy old data (created_at will auto-fill as NULL, but you can backfill later)
INSERT INTO notifications (notification_id, user_id, content, notification_type, is_sent, send_date)
SELECT notification_id, user_id, content, notification_type, is_sent, send_date
FROM notifications_old;

-- 4. Drop the old table
DROP TABLE notifications_old;

-- 5. (Optional) Backfill created_at for existing rows
